                    ...
                    <div className="sticky top-24 space-y-8">
                        ...
                        <div className="w-full">
                            ...
                            <div className="relative group">
                                ...
                                <div className="absolute -inset-1 bg-gradient-to-r from-blue-400/20 via-red-400/10 to-yellow-400/20 rounded-2xl blur-lg opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
                                    ...
                                    <div className="flex items-center gap-4 mb-4">
                                        ...
                                        <div className="relative flex-shrink-0">
                                            <div className={`w-12 h-12 rounded-full border-2 flex items-center justify-center transition-all duration-300 ${googleData
                                                ...
                                                : "bg-gray-50 border-gray-100 group-hover/btn:border-blue-200 group-hover/btn:bg-blue-50/50"
                                                }`}>
                                                {googleData ? (
                                            ...
                                            {!googleData && (
                                                <div className="absolute inset-0 rounded-full border-2 border-transparent group-hover/btn:border-blue-300/50 group-hover/btn:scale-110 transition-all duration-500" />
                                            )}
                                        </div>
                                        ...
                                        {!googleData && (
                                            <ArrowRight className="w-5 h-5 text-gray-300 group-hover/btn:text-[#0f766d] group-hover/btn:translate-x-1 transition-all duration-300 flex-shrink-0" />
                                        )}
                                    </div>
