            ...
            {isOpen && (
                <div className="lg:hidden bg-white border-b border-gray-200 p-6 space-y-4">
                    ...
                    <div className="flex items-center gap-4 pt-4 border-t border-gray-100">
                        <Link href="#" className="flex-1 text-center text-sm font-medium text-gray-700 px-4 py-2.5 rounded-lg border border-gray-200">Login</Link>
                        <Link href="#" className="flex-1 text-center text-sm font-medium text-white bg-gray-800 px-4 py-2.5 rounded-lg">Register</Link>
                    </div>
